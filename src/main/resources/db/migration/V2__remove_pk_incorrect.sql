...
ALTER TABLE fare_rules DROP CONSTRAINT fare_rules_pkey;
ALTER TABLE fare_rules
    ADD CONSTRAINT fare_rules_pkey PRIMARY KEY (fare_id, route_id);

ALTER TABLE fare_rules ALTER COLUMN origin_id DROP NOT NULL;
ALTER TABLE fare_rules ALTER COLUMN destination_id DROP NOT NULL;
ALTER TABLE fare_rules ALTER COLUMN contains_id DROP NOT NULL;